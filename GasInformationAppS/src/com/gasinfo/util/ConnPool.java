...
public class ConnPool {
	...
	private String url="jdbc:microsoft.sqlserver://localhost:1433;DatabaseName=GasInformation";
	...
	private Connection creatConnection() {
		...
		try {
			conn=DriverManager.getConnection("jdbc:sqlserver://localhost:1433;DatabaseName=GasInformation;",SQL_account,SQL_key);
