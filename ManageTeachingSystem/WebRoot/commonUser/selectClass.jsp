...
<html>
 ...
 <table border="1">
	...
	<td>
		...
		<div align="center"><%=tempCid %></div>
	</td>
	<td>
		<div align="center"><%=courses.get(i).getCname() %></div>
	</td>
	<td>
		<div align="center"><%=courses.get(i).getTeacher() %></div>
	</td>
	<td>
		<div align="center">
		<form action="AddClassAction.action" method="get">
		<input id="cid" name="cid" value=<%=tempCid %> type="hidden">
		<input type="submit" id="sub" value="添加" ></button>
		</form>
		</div>
	</td>
	</tr>
